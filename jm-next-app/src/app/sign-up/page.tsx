            ...
            { waitingForConfirmation == false ? (            
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                        autoComplete="email"
                        className="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-black outline outline-1 -outline-offset-1 outline-black placeholder:text-gray-500 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-emerald-500 sm:text-sm/6"
                    />
                    </div>
                </div>
                ...
                <div>
                    <button
                    type="submit"
                    className="flex w-full justify-center rounded-md bg-emerald-500 px-3 py-1.5 text-md font-semibold text-black shadow-sm hover:bg-emerald-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-500"
                    >
              ...
              <div>
                ...
                <form onSubmit={handleConfirmation} className="space-y-6">
                  <div>
                    <label htmlFor="code" className="block text-md mb-4 font-medium text-black">
                      {/* Confirmation Code */}
                    </label>
                    <input id="code" name="code" type="text" required autoComplete="confirmation-code" className="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-black outline outline-1 -outline-offset-1 outline-black placeholder:text-gray-500 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-emerald-500 sm:text-sm/6" />
                  </div>
                  <div>
                  <button
                    type="submit"
