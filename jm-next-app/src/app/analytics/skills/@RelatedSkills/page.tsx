...
export default function RelatedSkills() {
    ...
    return (
        <div className="p-4">
            <div className="max-h-[400px] overflow-y-auto rounded-lg border border-gray-200 shadow-sm bg-white/60">
                <div className="divide-y divide-gray-200">
                    {skillData?.relatedSkills.map((skill: any, index: number) => {
                        ...
                        return (
                            <div 
                                key={skill.keyword}
                                className="p-3 hover:bg-m-dark-green/30 transition-colors duration-150 flex items-center"
                            >
