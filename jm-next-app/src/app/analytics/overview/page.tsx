...
export default async function Overview() {
    ...
    return (
        <div className="container mx-auto p-4">
            ...
            <div className="grid grid-cols-2 xl:grid-cols-6 grid-rows-24 gap-4 text-center ">
                {/* Top Skills - Takes full width on first row */}
                
                {/* Second row - smaller components side by side */}
                <div className="rounded-lg shadow p-4 shadow-gray-300 shadow-md border border-gray-200 h-full flex flex-col bg-slate-100/50 col-span-1">
                    <h2 className="text-lg sm:text-xl font-semibold mb-4 text-gray-700">📊 Total Jobs Analyzed</h2>
                    <div className="flex-1 flex items-center justify-center">
                        <TotalJobs totalJobs={overviewData?.totalJobs || 0}/>
                    </div>
                </div>
                
                <div className="rounded-lg shadow p-4 shadow-gray-300 shadow-md border border-gray-200 lg:row-span-1 bg-slate-100/50 col-span-1">
                    <h2 className="text-lg sm:text-xl font-semibold mb-4 text-gray-700">💰 Average Salaries</h2>
                    <div className="flex-1 flex items-center justify-center">
                ...
                <div className="rounded-lg shadow p-4 shadow-gray-300 shadow-md border border-gray-200 lg:col-span-4 lg:row-span-2 bg-slate-100/50 col-span-2">
                ...
                <div className="rounded-lg shadow p-4 shadow-gray-300 shadow-md border border-gray-200 lg:col-span-2 bg-slate-100/50 col-span-2">
                ...
                <div className="rounded-lg shadow p-4 shadow-gray-300 shadow-md border border-gray-200 lg:col-span-3 bg-slate-100/50 col-span-2">
