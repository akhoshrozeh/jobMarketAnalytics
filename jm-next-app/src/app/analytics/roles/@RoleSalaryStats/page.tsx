...
export default function RoleSalaryStats() {
    const { roleData } = useRole();
    const stats = roleData?.roleSalaryStats;
    const marketSalaryAverage = roleData?.marketSalaryAverage?.[0];
    const marketTotalJobs = roleData?.marketTotalJobs;
